 ...
 */
class Version20171113171409 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE imp_sensor (id INT AUTO_INCREMENT NOT NULL, room_id INT NOT NULL, guid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', value_type VARCHAR(255) NOT NULL, switchable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, sensor_ip VARCHAR(50) NOT NULL, last_data_sent_at DATETIME DEFAULT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_17DD9FE22B6FCFB2 (guid), INDEX IDX_17DD9FE254177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
